# JRA Figma Page Scraping Project

This project aims to recreate a Figma design into a functional web page using Next.js, React, Tailwind CSS, and GSAP for animations.
